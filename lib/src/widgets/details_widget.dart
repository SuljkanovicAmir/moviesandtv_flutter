...
class MyDetailsWidget extends StatelessWidget {
  ...
  const MyDetailsWidget(this.mediaType, this.details, this.movieId,
      {super.key});

  @override
  Widget build(BuildContext context) {
    final posterPath = details['poster_path'];
    List<dynamic> genres = details['genres'];
    ...
    if (mediaType == 'tv') {
      List<dynamic> networks = details['networks'];
      ...
      if (details.containsKey("first_air_date")) {
                ...
                SizedBox(
                  ...
                  child: posterPath != null
                      ...
                      : const Icon(
                          ...
                          color: Colors.grey, // Choose the color for the icon
                        ),
                ),
                Positioned.fill(
                  bottom: -5,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              if (mediaType == 'tv')
                                Text(
                                  networkName.isNotEmpty ? networkName[0] : '',
                                  style:
                              ...
                              IconButton(
                                onPressed: () {
                                  Navigator.pushNamed(context, '/trailer',
                                      arguments: {'fetchVideo': fetchVideo});
                                },
                                icon: const Icon(
